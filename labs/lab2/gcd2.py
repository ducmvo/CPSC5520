...
class GroupCoordinatorDaemon(socketserver.BaseRequestHandler):
    """
    A Group Coordinator Daemon (GCD) which will respond with a list of potential 
    group members to a text message JOIN
...
if __name__ == '__main__':
    ...
    # port = int(sys.argv[1])
    port = 62135
    with socketserver.TCPServer(('localhost', port), GroupCoordinatorDaemon) as server:
